...
<div class="page-title mb-20">
    ...
    <div class="row mt-20">
        <div class="col-md-12 mb-30">
            ...
            <p><a target="_blank" href="{{ route('terms.show') }}">{{ __('Terms of Service') }}</a></p>
            
            <form action="{{ route('validate_admin_appterms') }}" method="post">
                @csrf
                <div class="row align-items-center mb-20">
                    <textarea name="appTerms" id="editor">{!! settings('appTerms') !!}</textarea>
                </div>
