<div>
    @if ( isset($unit_id) && isset($national_id) && isset($number) && isset($pilgrims_id) )

        <button type="button" class="btn btn-primary d-block mb-1" wire:click="printCard('print', {{$pilgrims_id}})">طباعة الكارت</button>
        <button type="button" class="btn btn-warning d-block mb-1" wire:click="printCard('save', {{$pilgrims_id}})">حفظ الكارت &nbsp;</button>
    @else
